...
int main(void) 
{
    ...
    size_t size_m1 = sizeof(sample.m1); 
    size_t size_m2 = sizeof(sample.m2); 
    size_t size_m3 = sizeof(sample.m3);
    size_t size_m4 = sizeof(sample.m4); 
    size_t size_m5 = sizeof(sample.m5); 
    size_t size_m6 = sizeof(sample.m6);
    size_t total_size = size_m1 + size_m2 + size_m3 + size_m4 + size_m5 + size_m6;

    /*構造体のサイズと各メンバサイズの合計を表示*/
    printf("構造体のサイズ=%zu メンバの合計サイズ=%zu\n", sizeof(struct SAMPLE_t),total_size);
